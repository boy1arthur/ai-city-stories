...
const PLAZA_TILE_MAP = [
  // 0123456789012345678
  'KKGSSSSSSRSSSSSSGKK', // 0  park edge
  'KGSSSSSSSRSSSSSSSKK', // 1  park + sidewalk border
  'SSAAAASSSPRFFFSSSSS', // 2  Arena(2-5,2-5) FeedTower(11-13,2-4)
  'SSAAAASSSPRFFFSSPSS', // 3  
  'SSAAAASSSPRFFFSPPSS', // 4  Oracle(15-16,3-5) + plaza paving
  'SSAAAASSSPLLLSOPPSS', // 5  Lab(10-12,5-7) Oracle
  'SSCCCSSSSPLLLSSPPPS', // 6  Cafe(2-4,6-7) Plaza paving area
  'SSCCCSSPSPLLLSSPPPS', // 7  
  'RRRRRRRRRRRRRRRRRRS', // 8  ── main pedestrian boulevard ──
  'SSBBBBSPPSSNNNSSPPS', // 9  Library(2-5,9-11) Newsstand(10-12,9-10) 
  'SSBBBBSPPSSNNNSSPPS', // 10 
  'SSBBBBSPPSSSSSSPPSS', // 11 
  'SSTTTSSKSSWWWWSSPSS', // 12 Tavern(2-4,12-13) Workshop(10-13,12-14)
  'SSTTTSSKSSWWWWSSSSS', // 13 
  'SSKKKKKKSSWWWWSSSSS', // 14 Garden park(2-7,14-16)
  'SSKKKKKKSSOOOSSSKKS', // 15 Observatory(10-12,15-16)
  'SSKKKKKKSSOOOSSSKKS', // 16 
  'GKKKKKKKKSSSSSSKKKK', // 17 park edge
];
...
const PLAZA_BUILDINGS: Building[] = [
  ...
  { id: 'feed_tower', name: 'Feed Tower', emoji: '📡', color: 'primary',
    gridX: 11, gridY: 2, width: 3, height: 3,
  ...
  { id: 'oracle', name: 'Oracle', emoji: '🔮', color: 'secondary',
    gridX: 15, gridY: 3, width: 2, height: 3,
  ...
  // ─── CORE MIDDLE: Research + Commerce ───
  { id: 'lab', name: 'Lab', emoji: '🧪', color: 'primary',
    gridX: 10, gridY: 5, width: 3, height: 3,
  ...
  { id: 'newsstand', name: 'Newsstand', emoji: '📰', color: 'accent',
    gridX: 10, gridY: 9, width: 3, height: 2,
  ...
  { id: 'tavern', name: 'Tavern', emoji: '🍺', color: 'accent',
    gridX: 2, gridY: 12, width: 3, height: 2,
  ...
  { id: 'workshop', name: 'Workshop', emoji: '🔧', color: 'primary',
    gridX: 10, gridY: 12, width: 4, height: 3,
  ...
  // ─── OUTSKIRTS: Park + Observatory ───
  { id: 'garden', name: 'Garden', emoji: '🌿', color: 'secondary',
    gridX: 2, gridY: 14, width: 6, height: 3,
  ...
  { id: 'observatory', name: 'Observatory', emoji: '🔭', color: 'primary',
    gridX: 10, gridY: 15, width: 3, height: 2,
