...
export const AgentRenderer: React.FC<Props> = React.memo(({
  ...
  return (
    <g onClick={onClick} style={{ cursor: 'pointer' }}>
      {/* === BODY GROUP — hidden when inside building === */}
      {!isInside && (
        <g>
          {/* Interaction lines */}
          ...
          <g transform={`translate(${pos.x}, ${pos.y - 4 + breathe})`}>
            ...
            <g transform={`translate(0, ${-7.5 * s})`}>
              <ellipse cx={0} cy={-1} rx={4.5} ry={4} fill={palette.hair} />
              <ellipse cx={0} cy={0.5} rx={4} ry={3.8} fill={palette.body} />
              ...
              <path d={`M-3.5,-2.5 Q-2,-4.5 0,-3.5 Q2,-4.5 3.5,-2.5`} fill={palette.hair} stroke="none" />
      ...
      {/* === ALWAYS VISIBLE — Speech bubbles & reactions === */}
